...
if dec > 9:
	...
	icon = str(dec)
print "${voffset 4}${color0}${font Pie charts for maps:size=14}"+icon+"${font}${color}   ${voffset -5}Root: ${font Liberation Sans:style=Bold:size=8}${color1}${fs_free_perc /}%${color}${font} ${alignr}${color2}${fs_free /}${color}"
