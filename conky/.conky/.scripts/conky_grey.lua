...
gauge = {
{
    ...
    graph_bg_colour=0xffffff,      graph_bg_alpha=0.1,
    graph_fg_colour=0xFFFFFF,      graph_fg_alpha=0.3,
    hand_fg_colour=0xB01515,       hand_fg_alpha=0.6,
    txt_radius=64,
...
},
{
    ...
    graduation_thickness=9,        graduation_mark_thickness=2,
    graduation_unit_angle=27,
...
{
    name='fs_used_perc',           arg='/media/shared250',                max_value=100,
    x=85,                          y=410,
    graph_radius=24,
    graph_thickness=10,
    graph_start_angle=180,
...
},
{
    ...
    graph_bg_colour=0xffffff,      graph_bg_alpha=0.1,
    graph_fg_colour=0xFFFFFF,      graph_fg_alpha=0.3,
    hand_fg_colour=0xB01515,       hand_fg_alpha=0.5,
    txt_radius=60,
    txt_weight=0,                  txt_size=8.0,
    txt_fg_colour=0xffffff,        txt_fg_alpha=0.5,
    graduation_radius=28,
