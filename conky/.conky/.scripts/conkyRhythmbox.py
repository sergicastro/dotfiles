...
class MusicData:
    def __init__(self,status,title,album,length,artist,tracknumber,genre,year,filename,current_position_percent,current_position,rating,volume):
        self.status = status
        self.title = title
        self.album = album
        self.length = length
                ...
                if self.testDBus(bus, 'org.gnome.Rhythmbox'):
                    ...
                    try:
                        ...
                        if len(uri) == 0:
                            ...
                            self.musicData = MusicData(status,None,None,None,None,None,None,None,None,None,None,None,volume)
                        else:
                            ...
                            self.musicData = MusicData(status,title,album,length,artist,tracknumber,genre,year,filename,current_position_percent,current_position,rating,volume)                           
...
def main():
    ...
    if options.version == True:
        print >> sys.stdout,"conkyRhythmbox v.2.06"
    else:
